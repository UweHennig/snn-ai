...
public class FeedbackModel {
    ...
    static final GroupLayout LAYOUT = MemoryLayout.structLayout(
        ...
        JAVA_INT.withName("feedbackType"),
        JAVA_INT.withName("temporalFilterIndex"),
        JAVA_INT.withName("informationFilterIndex"),
        JAVA_INT.withName("relatedNeuronElementRef")
    ).withByteAlignment(8);

    static final VarHandle VH_LOCK =
        LAYOUT.arrayElementVarHandle(MemoryLayout.PathElement.groupElement("lock"));
    static final VarHandle VH_FEEDBAACK_TYPE =
        LAYOUT.arrayElementVarHandle(MemoryLayout.PathElement.groupElement("feedbackType"));
    ...
    int getRelatedNeuronElementRef(int index) {
    ...
    int getFeedbackType(int index) {
        return (int)VH_FEEDBAACK_TYPE.get(segment, 0L, index);
    }

    void setFeedbackType(int index, int feedbackType) {
        VH_FEEDBAACK_TYPE.set(segment, 0L, index, feedbackType);
    }
}
