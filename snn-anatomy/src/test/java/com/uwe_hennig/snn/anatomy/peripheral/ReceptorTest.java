...
//
//            long sizeA = ReceptorModelManager.matrixSize(numHeadersA, numRowsA, numColumnsA, numSlotsPerCellA);
//            long sizeB = ReceptorModelManager.matrixSize(numHeadersB, numRowsB, numColumnsB, numSlotsPerCellB);
//            long sizeMeta = ReceptorModelManager.metaSize();
//
//            ReceptorModelManager manager = ReceptorModelManager.init(receptors, sizeA + sizeB + sizeMeta);
...
//
//            assertEquals(numHeadersA, viewA.getNumHeaders(receptorAId));
//            assertEquals(numRowsA, viewA.getNumRows(receptorAId));
//            assertEquals(numColumnsA, viewA.getNumColumns(receptorAId));
//            assertEquals(numSlotsPerCellA, viewA.getNumSlotsPerCell(receptorAId));
//
//            assertEquals(capacityB, viewB.getCapacity());
//            assertEquals(numHeadersB, viewB.getNumHeaders(receptorBId));
//            assertEquals(numRowsB, viewB.getNumRows(receptorBId));
//            assertEquals(numColumnsB, viewB.getNumColumns(receptorBId));
//            assertEquals(numSlotsPerCellB, viewB.getNumSlotsPerCell(receptorBId));
//
...
//                    // set A
//                    for (int row = 0; row < viewA.getNumRows(receptorAId); row++) {
//                        for (int col = 0; col < viewA.getNumColumns(receptorAId); col++) {
//                            viewA.setTargetId(r, row, col, ops++);
//                        }
//                    }
//                    // set B
//                    for (int row = 0; row < viewB.getNumRows(receptorBId); row++) {
//                        for (int col = 0; col < viewB.getNumColumns(receptorBId); col++) {
